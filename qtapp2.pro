...
UBUNTU_TRANSLATION_DOMAIN="qtapp2.timo-jyrinki"
...
aptest.commands = QML2_IMPORT_PATH=$$OUT_PWD/backend bash $$PWD/qtapp2/tests/autopilot/run
aptest.depends  = sub-qtapp2 sub-backend-App

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/backend/tests/unit -import $$OUT_PWD/backend
unittest.commands += && /usr/bin/qmltestrunner -input $$PWD/qtapp2/tests/unit -import $$OUT_PWD/backend
unittest.depends  = sub-qtapp2 sub-backend-App
